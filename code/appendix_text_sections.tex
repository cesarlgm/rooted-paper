...
I use harmonized cross-country data from IPUMS International to build Figure \ref{fig:figure_1} and
Rable \ref{tab:table_4}. They show local employment rates for men and women aged 18-64 for a
cross-section of countries. I use the latest decennial census sample available. In
