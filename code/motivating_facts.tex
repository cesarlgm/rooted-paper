...
\ref{tab:cross-country_appendix}. All results discussed here generalize to that broader sample.
Further details on the cross-country data are provided in Appendix \ref{sec:country_data}.}
