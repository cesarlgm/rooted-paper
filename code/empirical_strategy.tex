...
\subsection{Birthplace FLFP is highly predictive of women's labor supply}	
...
\begin{eqnarray}
	...
	e_{it}&=&\omega_{dt}+\boldsymbol \beta FLFP_{it}+\phi MLFP_{it}+X_{it}\kappa+\varepsilon_{it}
\end{eqnarray}
...
\smartinputtable{input/tab/table_baseline_birthplace_persistence_exp.tex}
...
%\smartinputtable{input/table_7.tex}}
